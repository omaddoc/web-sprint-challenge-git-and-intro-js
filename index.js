...
console.log('first artist name: ', artists[0].name);
...
function getArtistByIndex(/*Your Code Here*/ arr, num) {
  /*Your Code Here*/
  const id = arr[num].id;
...
function removeArtist(/*Your Code Here*/ arr, num) {
  /*Your Code Here*/
  const newArr = [...arr];
  newArr.splice(num, 1);
  return newArr;
...
function artistInfo(/*Your Code Here*/ arr, name) {
  /*Your Code Here*/
  for (let i = 0; i < arr.length; i++) {
    if (arr[i].name === name) {
      return arr[i].bio;
...
function artistByCountry(/*Your Code Here*/ arr, nationality) {
  /*Your Code Here*/
  let selectedArtists = [];
  for (let i = 0; i < arr.length; i++) {
    if (arr[i].nationality === nationality) {
      selectedArtists.push(arr[i].name);
    }
  }
